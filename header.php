                ...
                <div class="relative container mx-auto flex h-16 items-center justify-between">
                    ...
                    <div class="relative ml-3">
                        ...
                        if (isset($_SESSION['user_id']) && isset($_SESSION['role']) && $_SESSION['user_id'] && $_SESSION['role']) {
                            ...
                            if ($row['role'] == 'user') {
                                echo '<a href="/vaccination_injections/result.php" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Xem kết quả đăng ký</a>';
                            }
